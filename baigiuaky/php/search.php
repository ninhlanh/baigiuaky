...
// file: search_student.php
$search = isset($_POST['search']) ? $_POST['search'] : '';

$conn = new mysqli("localhost", "username", "password", "qlsv_ninhthilanh");
...
if ($result->num_rows > 0) {
    while ($row = $result->fetch_assoc()) {
        echo "ID: " . $row['id'] . " - Họ và tên: " . $row['fullname'] . " - Ngày sinh: " . $row['dob'] .
             " - Giới tính: " . ($row['gender'] == 1 ? "Nam" : "Nữ") . " - Quê quán: " . $row['hometown'] .
             " - Trình độ: " . ["Tiến sĩ", "Thạc sĩ", "Kỹ sư", "Khác"][$row['lever']] . " - Nhóm: " . $row['group_id'] . "<br>";
    }
} else {
